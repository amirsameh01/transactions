...
SECRET_KEY = 'django-insecure-^=e3lgxtk!efvar-i_++7g9r$)2ki_7jwc6xu%#_*0$*04vxrw'
...
MONGO_DB = 'transactions' #TODO: read from .env :)
MONGO_HOST = 'mongo'
MONGO_PORT = 27017
...
CELERY_BROKER_URL = 'redis://redis:6379/0'  #TODO: read from .env :))
CELERY_RESULT_BACKEND = MONGO_DATABASE_HOST
